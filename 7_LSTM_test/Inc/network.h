...
#define AI_NETWORK_IN { \
  AI_BUFFER_OBJ_INIT(AI_BUFFER_FORMAT_FLOAT, 20, 1, 1, 1, NULL), \
}
#define AI_NETWORK_IN_SIZE { \
  (20 * 1 * 1), \
}
#define AI_NETWORK_IN_1_SIZE  (20 * 1 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((20 * 1 * 1) * 4)
...
#define AI_NETWORK_OUT_1_SIZE  (20 * 1 * 1)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((20 * 1 * 1) * 4)
