...
#ifndef __AI_NETWORK_TEST_H__
#define __AI_NETWORK_TEST_H__
#pragma once

#include "ai_platform.h"

#define AI_NETWORK_TEST_MODEL_NAME          "network_test"
 ...
 * @ref ai_network_test_create. Both the activations memory buffer 
 ...
 * using @ref ai_network_test_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_NETWORK_TEST_*
 * defines into file @ref network_test.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_network_test_forward(
  ai_handle network, const ai_buffer* input);


AI_API_DECLARE_END

#endif /*__AI_NETWORK_TEST_H__*/
